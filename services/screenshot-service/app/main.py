...
# The main uvicorn worker (port 80) blocks during pyrender rendering, and
...
def render_screenshots_endpoint(request: ScreenshotRequest):
    ...
    try:
        ...
        valid_angles = {"front", "back", "left", "right", "top", "bottom", "ortho_45", "ortho_45_bottom", "interior", "isometric", "isometric_back"}
