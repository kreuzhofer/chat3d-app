...
const SETTINGS_REGISTRY = new Map<string, SettingMeta>([
  ...
  ["workbench.agent_max_steps", { default: 25, label: "Agent max tool-use steps", description: "Maximum number of tool-use steps in the agent codegen loop. Workbench needs more iterations to converge on hard prompts.", pipeline: "workbench", min: 3, max: 100, step: 1 }],
