...
- If you need exact dimensions, specifications, or tolerances for components (connectors, fasteners, dev boards, 3D printing), use search_reference with relevant tags
