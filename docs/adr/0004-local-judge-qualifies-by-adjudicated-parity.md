...
- **Stability** (mechanical): a second run under the same Instrument id and settings agrees with the first at or inside the reference's own floor — hard pass/fail flips at or under 2.9% of items, identical items at or above 90%.
